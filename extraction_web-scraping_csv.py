...
if(os.path.exists('data/megasenna_historico.csv')):
    ...
    with open('data/megasenna_historico.csv', 'a', encoding='utf-8') as csv_file:    
        fieldnames = ["data_sorteio", "cd_sorteio", "ganhadores", "premio", "dezenas_sorteadas"]
        writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
        writer.writeheader()
        writer.writerow(mesa_senna)

    print(mesa_senna['premio'])
